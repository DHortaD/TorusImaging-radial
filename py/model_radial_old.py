...
class TorusImaging1DSpline(TorusImaging1D):
    ...
    def auto_init(
        ...
        **kwargs
        ...
        bounds["pos0"] = ([-2.0, 2.0] * u.kpc).decompose(units).value
        # bounds["R0"] = ([-20.0, 20.0] * u.kpc).decompose(units).value
        # bounds["vphi0"] = ([0.0, 300.0] * u.km / u.s).decompose(units).value
        # bounds['Lz0'] = ([0.0 ,5000.0] * u.kpc * u.km / u.s).decompose(units).value
        # bounds["vcirc0"] = ([0.0, 300.0] * u.km / u.s).decompose(units).value
    ...
    def estimate_init_params(
        ...
        # p0 = {"R0": 0.0, "Lz0": 0.0, "vcirc0": 229.0,  "vel0": 0.0, "ln_Omega0": np.log(Omega0)}
